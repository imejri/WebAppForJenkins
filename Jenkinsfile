...
node {
    withCredentials([sshUserPrivateKey(credentialsId: 'identity', keyFileVariable: 'private', passphraseVariable: '', usernameVariable: 'userName')]) {
        remote.user = userName
        remote.identityFile = private
