...
node {
    withCredentials([sshUserPrivateKey(credentialsId: 'identity', keyFileVariable: 'key-ssh', passphraseVariable: '', usernameVariable: 'userName')]) {
        remote.user = 'userName'
        remote.identityFile = 'key-ssh'
